...
// 이벤트 리스너 : 이벤트를 감지, 이벤트가 발생되면 실제적으로 이벤트를 처리할 수 있도록 
// 				만든 인터페이스
...
public class Ex01_ActionEvent extends JFrame implements ActionListener{
	...
	public Ex01_ActionEvent() {
		...
		// ActingEvent는 getSource로 어디에있는지 알아낼수 있다.
	...
	// ActionListener일 때, 이벤트 처리를 받아서 실제로 처리해주는 메서드
	@Override
	public void actionPerformed(ActionEvent e) {
		//System.out.println("버튼을 눌렀네요");
		JButton obj = (JButton) e.getSource();//원래는 Object obj = e.getSource();
		if(obj ==jb1) {

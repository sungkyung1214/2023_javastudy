...
public class Ex04_ItemListener2 extends JFrame implements ItemListener, ActionListener{
	...
	public Ex04_ItemListener2() {
		...
		jsp = new JScrollPane(jta,
				...
				ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);//s.p.c이게 정상
	...
	// ActionListener 해결해주는 추상 메서드(버튼)
	@Override
